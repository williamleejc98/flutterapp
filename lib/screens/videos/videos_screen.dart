...
import '../search/widgets/search_empty_result.dart';
...
class _VideosScreenState extends State<VideosScreen> with AppBarMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final hasErrorMessage = _errMsg?.isNotEmpty ?? false;
    final messageToShow =
        hasErrorMessage ? _errMsg! : S.of(context).noVideoFound;
        ...
        child: _isIniting
            ...
            : _videos.isEmpty
                ? EmptySearch(
                    ...
                    paddingImage: const EdgeInsets.only(bottom: 0),
                    width: 60,
                    image: kEmptyVideo,
                    title: messageToShow,
                  )
