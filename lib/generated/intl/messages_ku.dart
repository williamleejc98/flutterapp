...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m24(itemCount) => "${itemCount} ئایتم";

  static String m25(price) => "کۆى گشتى هەڵبژاردنەکان: ${price}";

  static String m28(percent) => "داشکاندن ${percent} %";

  static String m29(second) => "${second} چرکە پێش ئێستا";
  ...
  static String m33(total) => "${total} بەرهەمەکان";

  static String m35(date) => "گونجاوە تا ${date}";

  static String m36(message) => "ئاگاداری: ${message}";

  static String m38(length) => "${length} بەرهەم دۆزرایەوە";
