...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m24(itemCount) => "${itemCount} ኣቕሑት";

  static String m25(price) => "ድምር ኣማራጺታት: ${price}";

  static String m27(total) => "ብዝሒ ፦ ${total}";

  static String m28(percent) => "መሸጣ ${percent}%";

  static String m29(second) => "${second} ቅድሚ ኻልኢታት";

  static String m30(totalCartQuantity) =>
      "ዓረብያ ዕድጊ ${totalCartQuantity} ንብረት/ታት";

  static String m31(numberOfUnitsSold) => "እተሸጠ፦ ${numberOfUnitsSold}";

  static String m33(total) => "${total}  ፍርያት";

  static String m35(date) => "ቅቡል ክሳብ ${date}";

  static String m36(message) => "መጠንቀቕታ ፦ ${message}";

  static String m37(defaultCurrency) =>
      "እቲ ኣብዚ እዋን እዚ እተመርጸ ባጤራ ነቲ ኣብ ቦርሳ ዘሎ ኣቕሓ ኣይርከብን እዩ:: በጃኻ ናብ ${defaultCurrency} ለወጥዎ";

  static String m38(length) => "ፍርያት ${length} ረኸብና";

  static String m39(week) => "ሰሙን ${week}";

  static String m41(year) => "${year} ቅድሚ ዓመታት";

  static String m42(total) => "ትእዛዝ ክትእዝዝ መዲብካ ኣለኻ #${total}";
